  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Construction Tool Rental - Empowering individuals with easy access to essential construction tools from multiple outlets, anytime, anywhere."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Construction Tool Rental - Empowering individuals with easy access to essential construction tools from multiple outlets, anytime, anywhere.`}
            </Text>
            <Box
